    ...
    return (
        <>
            ...
            <article>
                <div>
                    <header>
                        <div className="font-mission space-y-1 border-b border-muted-foreground pb-10 text-center dark:border-muted">
                    ...
                    <div className="divide-y divide-muted-foreground pb-8 dark:divide-muted xl:divide-y-0">
                        <div className="divide-y divide-accent-foreground dark:divide-accent xl:col-span-3 xl:row-span-2 xl:pb-0">
                            <div className=" flex prose prose-sm max-w-none pb-8 pt-10 dark:prose-invert">
                                ...
                                <div className='flex-1 font-mission max-w-5xl'>{children}</div>
                            </div>
                        </div>
                        <footer>
                            <div className="flex flex-col font-mission text-accent opacity-75 text-sm font-medium sm:flex-row sm:justify-between sm:text-base">
                                {prev && prev.path && (
